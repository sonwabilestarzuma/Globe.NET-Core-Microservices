using Globe.Services.OrderAPI.Messages;
using Globe.Services.OrderAPI.Models;
using Globe.Services.OrderAPI.RabbitMQSender;
using Globe.Services.OrderAPI.Repository;
...
namespace Globe.Services.OrderAPI.Messaging
{
