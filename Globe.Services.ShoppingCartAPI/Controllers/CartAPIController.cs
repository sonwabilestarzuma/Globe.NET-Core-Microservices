...
using Globe.Services.ShoppingCartAPI.Messages;
using Globe.Services.ShoppingCartAPI.Models.Dto;
using Globe.Services.ShoppingCartAPI.RabbitMQSender;
using Globe.Services.ShoppingCartAPI.Repository;
...
namespace Globe.Services.ShoppingCartAPI.Controllers
{
    [ApiController]
    [Route("api/cart")]
